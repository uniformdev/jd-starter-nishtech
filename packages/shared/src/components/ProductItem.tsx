...
const ProductItem: FC<Props> = ({ product, showAddToCart = false }) => {
  ...
  return (
    <div className="group flex flex-1 flex-col w-full mx-auto mb-auto mt-0">
      <div className="relative flex flex-col items-center lg:px-0">
        ...
        >
          ...
          {showAddToCart && (
            <ProductAddToCartButton product={product} quantity={1} className="w-full md:w-32 !px-2 text-sm" />
          )}
        </Link>
      </div>
    </div>
